...
#ANDROIDSTUDIO=/home/himanshu/Documents/androidenv/android-studio/bin/
#export ANDROIDSTUDIO
#PATH=$PATH:$ANDROIDSTUDIO
#export PATH

#export PYTHONSTARTUP=$HOME/.pythonstartup.py
export EDITOR="/usr/bin/vim"
alias lastinstalled='grep -e `date +%Y-%m-%d` /var/log/dpkg.log | awk '\''/install / {print $4}'\'' | uniq'
...
alias rmpyswp="sudo rm *.pyc *.swp"
alias rmpkg="sudo apt get purge"
alias srpkg="apt-cache search"
